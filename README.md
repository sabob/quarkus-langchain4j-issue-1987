...
https://github.com/quarkiverse/quarkus-langchain4j/issues/1987

A Quarkus-Langchain4j project to highlight 2 issues:
...
class org.acme.pojo.Pojo (java.util.LinkedHashMap is in module java.base of loader 'bootstrap'; org.acme.pojo.Pojo 
...
Set a valid `quarkus.langchain4j.openai.api-key=`

Toggle between static and programmatic tools:
`application.properties app.programmatic.tools.enabled`

NOTE: There are 2 @TODO items in the code that narrows down on the issues. 
